...
<head>
  ...
  <style>
    body {
      background-image: url('image/login-bg.jpg'); /* Replace 'background-image.jpg' with the path to your actual background image file */
    ...
    <div class="container py-5 h-100">
      <div class="row d-flex align-items-center justify-content-center h-100">
        <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
          ...
          <p class="text-center h1 fw-bold mb-4 mx-1 mx-md-3 mt-3" style="color: green;">Login</p>
            <!-- Email input -->
            <div class="form-outline mb-4">
            <label class="form-label" for="form1Example13" style="color: orange;"><i class="bi bi-person-circle"></i> Username</label>
          ...
          <p align="center" style="color: purple;">I don't have any account <a href="register.php" class="text-warning" style="font-weight:600;text-decoration:none;">Register Here</a></p>
        </div>
      </div>
    </div>
  </section>
